...
## 1. Project Overview
The SaudiEx Tracking App is a Vite-based React application providing real-time GPS tracking, historical data playback, geofencing, and alert management. It integrates with the Gimi/TrackSolid Pro IoT API.
