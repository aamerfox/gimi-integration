        ...
        if (accessToken === 'demo_token') {
            return {
                ...
                result: [
                    ...
                    { imei: '987654321098765', deviceName: 'شاحنة النقل الثقيل', status: '2', course: 0, speed: 0, activeTime: '2026-04-15 09:30:00' },
                    { imei: '111222333444555', deviceName: 'سيارة المبيعات', status: '1', course: 180, speed: 40, activeTime: '2026-04-15 11:15:00' }
                ]
            };
        }
        return api.post('', {
        ...
        if (accessToken === 'demo_token') {
            return {
                ...
                result: [
                    ...
                    { imei: '987654321098765', lat: 24.7236, lng: 46.6853, speed: 0, course: 0 },
                    { imei: '111222333444555', lat: 24.7436, lng: 46.6953, speed: 40, course: 180 }
                ]
            };
        }
        return api.post('', {
